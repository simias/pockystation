...
impl Instruction {
    ...
    fn sub(self, cpu: &mut Cpu, rd: RegisterIndex, a: u32, b: u32) {
    ...
    fn execute(self, cpu: &mut Cpu) {
        match self.opcode() {
            ...
            0x10a         => self.op10a_cmp(cpu),
            0x10c         => self.op10c_orr(cpu),
            0x10d         => self.op10d_mul(cpu),
            ...
            0x1e0...0x1ff => self.op1ex_ldrb_ri5(cpu),
    ...
    fn op02x_lsr_ri5(self, cpu: &mut Cpu) {
        let rd     = self.reg_0();
        let rm     = self.reg_3();
        let shift  = self.imm5();
    ...
    fn op06x_sub_rr(self, cpu: &mut Cpu) {
        let rd = self.reg_0();
        let rn = self.reg_3();
        let rm = self.reg_6();
    ...
    fn op07x_add_i3(self, cpu: &mut Cpu) {
        let rd = self.reg_0();
        let rn = self.reg_3();
        let b  = self.imm3();
    ...
    fn op08x_mov_i8(self, cpu: &mut Cpu) {
        let rd  = self.reg_8();
        let val = self.imm8();
    ...
    fn op0ax_cmp_i8(self, cpu: &mut Cpu) {
        let rn  = self.reg_8();
        let b   = self.imm8();
    ...
    fn op0cx_add_i8(self, cpu: &mut Cpu) {
        let rd  = self.reg_8();
        let b   = self.imm8();
    ...
    fn op0ex_sub_i8(self, cpu: &mut Cpu) {
        let rd  = self.reg_8();
        let b   = self.imm8();
    ...
    fn op103_lsr_r(self, cpu: &mut Cpu) {
        let rd = self.reg_0();
        let rs = self.reg_3();
    ...
    fn op1ex_ldrb_ri5(self, cpu: &mut Cpu) {
        let rd     = self.reg_0();
        let rn     = self.reg_3();
        let offset = self.imm5();
    ...
    fn op26x_ldr_sp(self, cpu: &mut Cpu) {
        let rd  = self.reg_8();
        let imm = self.imm8() << 2;
    ...
    fn op2c2_sub_sp(self, cpu: &mut Cpu) {
        let offset = self.imm7() << 2;
